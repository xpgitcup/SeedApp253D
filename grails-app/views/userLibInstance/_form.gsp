...
<div class="fieldcontain ${hasErrors(bean: userLibInstanceInstance, field: 'fileName', 'error')} required">
	<label for="fileName">
		<g:message code="userLibInstance.fileName.label" default="File Name" />
		<span class="required-indicator">*</span>
	</label>
	<g:textField name="fileName" required="" value="${userLibInstanceInstance?.fileName}"/>
